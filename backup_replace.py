...
print("Backup database backup_egateway.sql")

subprocess.Popen(str(rec[0][1]) + "mysqldump -u root -proot egateway > " + str(rec[0][0]) + "gui/public/dist/upload/backups/backup_egateway.sql", shell=True)
